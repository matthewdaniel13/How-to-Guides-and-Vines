...
function guide_post_types()
{
	register_post_type('Air Filter', array(
		'public' => true,
		'labels' => array(
			'name' => "Air Filter"
		),
	...
	register_post_type('Oil Change',array(
		'supports' => array('title', 'editor'),
		'rewrite'=> array('slug' => 'Oil Change' ),
		'has_archive' => true,
		'public' => true, 
		'labels' => array(
		'name' => "Oil Change",
	...
	register_post_type('Fluid Levels', array(
		'public' => true,
		'labels' => array(
			'name' => "Fluid Levels"
		),
...
add_action('init', 'guide_post_types');
