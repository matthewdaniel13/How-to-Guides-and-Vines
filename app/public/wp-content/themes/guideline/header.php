...
<body <?php body_class(); ?>>
  ...
  <div id="pageholder" <?php if (get_theme_mod('guideline_box_layout')) {
    ...
    <div class="hdrright">
      <div class="login-signup">
        <?php if (is_user_logged_in()) : ?>
          <a href="<?php echo wp_logout_url(home_url()); ?>"><?php esc_html_e('Logout', 'guideline'); ?></a>
        <?php else : ?>
          <a href="<?php echo wp_login_url(); ?>"><?php esc_html_e('Login', 'guideline'); ?></a>
          <a href="<?php echo wp_registration_url(); ?>"><?php esc_html_e('Sign Up', 'guideline'); ?></a>
        <?php endif; ?>
      </div><!-- .login-signup -->
          ...
          <?php for ($p = 1; $p < 5; $p++) { ?>
            <?php if (get_theme_mod('guideline_page_column' . $p, false)) { ?>
              ...
              <?php while ($querymax->have_posts()) : $querymax->the_post(); ?>
                <div class="colsfour <?php if ($p % 4 == 0) {
                                        echo "last_column";
                                      } ?>">
